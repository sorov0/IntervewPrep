...
Design Patterns Used: SOLID Principles, Strategy, Factory, Dependency Inversion
...
3. ParkingSpotManager (has-a parking spot)
...
5. Ticket (has-a vehicle, parking spot)
   _____________
   entryTime: Long
   vehicle: Vehicle
...
6. EntranceGate (has-a ParkingSpotManagerFactory, Ticket)
...
10. CostComputation (has-a Pricing Strategy)
